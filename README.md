...
**[Blog App]** is a classic example of a blog website. A functional website that shows the list of posts and empower readers to interact with them by adding comments and liking posts.
...
<details>
<summary>Blog app built with Rails.</summary>
...
Feel free to check the [issues page](https://github.com/dfsalam/blogapp/issues).
